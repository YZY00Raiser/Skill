---
name: "test-case-analyzer-v4"
description: "Analyzes test cases and generates comprehensive bilingual (English/Chinese) testing knowledge base documents for code directories. Invoke when user needs to analyze test suites, extract test feature points, or create test documentation with version 4 format."
---

# Test Case Analyzer V4 / 测试用例分析器 V4
...
**Test Goal / 测试目标**: English description of what the test validates / 中文描述测试验证的内容
...
5. **Test Goal / 测试目标**: MUST provide complete bilingual description / 必须提供完整的双语描述
   - Format / 格式: `**Test Goal / 测试目标**: English description / 中文描述`
   - Example / 示例: `**Test Goal / 测试目标**: Validate single-batch throughput for MoE models on 2-GPU setups / 验证 MoE 模型在双卡配置下的单批吞吐量`
